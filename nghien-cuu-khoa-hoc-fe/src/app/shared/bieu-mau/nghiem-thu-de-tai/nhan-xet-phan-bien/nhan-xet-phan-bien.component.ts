...
@Component({
  selector: 'app-nhan-xet-phan-bien',
  templateUrl: './nhan-xet-phan-bien.component.html',
  styleUrls: ['./nhan-xet-phan-bien.component.scss']
})
export class NhanXetPhanBienComponent implements OnInit {
