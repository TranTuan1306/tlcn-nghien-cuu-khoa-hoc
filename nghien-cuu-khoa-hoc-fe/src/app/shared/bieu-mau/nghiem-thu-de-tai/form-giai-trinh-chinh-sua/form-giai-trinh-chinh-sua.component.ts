...
export class FormGiaiTrinhChinhSuaComponent implements OnInit {
  ...
  @Input() modalData: ModalData<GiaiTrinhChinhSua>;
  ...
  ngOnInit() {
    ...
    if (this.modalData.action === SystemConstant.ACTION.EDIT) {
      this.form.patchValue({
        noiDungGopY: this.modalData.data.noiDungGopY,
        ketQuaChinhSuaBoSung: this.modalData.data.ketQuaChinhSuaBoSung,
        ghiChu: this.modalData.data.ghiChu,
      });
    }
  }
  ...
  createForm() {
    this.form = this.fbd.group({
      noiDungGopY: ['', [Validators.required]],
      ketQuaChinhSuaBoSung: ['', [Validators.required]],
