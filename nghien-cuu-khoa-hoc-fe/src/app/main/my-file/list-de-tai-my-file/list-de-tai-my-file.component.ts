...
@Component({
  selector: 'app-list-de-tai-my-file',
  templateUrl: './list-de-tai-my-file.component.html',
  styleUrls: ['./list-de-tai-my-file.component.scss', './../../../../assets/theme/css/main.css', '../../../../assets/theme/css/main.css']
})
export class ListDeTaiMyFileComponent implements OnInit {
  ...
  routerLinkToComponent(id: string) {
    this.spinner.show();
    setTimeout(() => {
      this.router.navigate(['/work/my-file', id]);
      this.spinner.hide();
    }, 500);
  }
