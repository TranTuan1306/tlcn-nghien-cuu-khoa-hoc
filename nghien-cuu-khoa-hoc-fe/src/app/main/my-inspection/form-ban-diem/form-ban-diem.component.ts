...
@Component({
  selector: 'app-form-ban-diem',
  templateUrl: './form-ban-diem.component.html',
  styleUrls: ['./form-ban-diem.component.scss']
})
export class FormBanDiemComponent implements OnInit {
  // Ngon ngu hien thi //////////
  ...
  modalCreateView(template: TemplateRef<unknown>, data: ThanhVienHoiDongNghiemThu, modalWidth?: number) {
    this.fileId = data.filePhieuDiemHoiDong;
