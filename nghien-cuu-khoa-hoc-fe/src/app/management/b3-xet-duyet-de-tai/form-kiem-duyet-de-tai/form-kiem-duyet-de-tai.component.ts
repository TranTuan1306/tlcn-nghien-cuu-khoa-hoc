...
@Component({
  selector: 'app-form-kiem-duyet-de-tai',
  templateUrl: './form-kiem-duyet-de-tai.component.html',
  styleUrls: ['./form-kiem-duyet-de-tai.component.scss']
})
export class FormKiemDuyetDeTaiComponent implements OnInit {
  ...
  sendMailToEdit() {
    if (this.form.valid) {
      ...
      this.deTaiSvc.sendMailToEditKHCN(this.modalData.data.id,
