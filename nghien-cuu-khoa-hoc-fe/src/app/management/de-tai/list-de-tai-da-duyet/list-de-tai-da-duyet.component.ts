...
@Component({
  selector: 'app-list-de-tai-da-duyet',
  templateUrl: './list-de-tai-da-duyet.component.html',
  styleUrls: ['./list-de-tai-da-duyet.component.scss']
})
export class ListDeTaiDaDuyetComponent implements OnInit {
  ...
  ngOnInit() {
    this.breadcrumbObj.heading = this.languageData[this.langCode].APPROVED_TOPICS;
