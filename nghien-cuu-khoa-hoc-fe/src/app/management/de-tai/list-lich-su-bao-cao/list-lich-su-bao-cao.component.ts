...
@Component({
  selector: 'app-list-lich-su-bao-cao',
  templateUrl: './list-lich-su-bao-cao.component.html',
  styleUrls: ['./list-lich-su-bao-cao.component.scss']
})
export class ListLichSuBaoCaoComponent implements OnInit {
